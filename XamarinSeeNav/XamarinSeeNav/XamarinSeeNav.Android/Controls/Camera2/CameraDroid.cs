...
namespace Seek.Droid.Controls.Camera2Forms.Camera2
{
    public class CameraDroid : FrameLayout, TextureView.ISurfaceTextureListener
    {
        ...
        // added singleton so that both cameraviewrenderer and angleofview can get the same instance
        static CameraDroid _cameraDroid;
        public static CameraDroid Get()
        {
            if(_cameraDroid == null)
            {
                _cameraDroid = new CameraDroid(Android.App.Application.Context);
            }
            return _cameraDroid;
        }
        ...
        public string CameraId
        {
            get
            {
                if(_cameraId == null)
                {
                    ...
                    {
                        CameraCharacteristics chararc = CameraManager.GetCameraCharacteristics(cameraIds[i]);

...
namespace SeeNav.Controls
{
    ...
    { 
        ...
        /*
        public Settings.ViewModel Settings { get; set; } = SeeNav.Settings.ViewModel.Get();
        ...
        */
        ...
        public SeeNav.Controls.Entry Entry { get; }
        ...
        public SearchEntry(SeeNav.Controls.Entry entry, ImageButton clear)
        {

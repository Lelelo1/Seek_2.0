...
[assembly: Dependency(typeof(SeeNav.iOS.iOS_Mixpanel))]
namespace SeeNav.iOS
{
    public class iOS_Mixpanel : INativeMixpanel
    {
        ...
        public iOS_Mixpanel()
        {
            ...
            var token = runtime == Runtime.Production ? Secret.Secrets.SeeNav.MIXPANEL_TOKEN_PRODUCTION : Secret.Secrets.SeeNav.MIXPANEL_TOKEN_DEVELOPMENT;
